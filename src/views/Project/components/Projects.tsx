                ...
                <>
                    <div className="max-w-5xl mx-auto">
                        <GlassCard variant="glass">
                            <GlassCard.Body>
                                <GlassCard.Image shape="square" className="w-[400px] h-[250px] ">
                                    <img
                                ...
                                <GlassCard.Description>
                                    ...
                                    <GlassCard.Footer>
                                        <div className="flex flex-row sm:justify-start justify-center items-center gap-4 mt-2">
                                            {state.selected.url && (
                                                <GlassLink variant="glass" href={state.selected.url}
                                            ...
                                            {state.selected.github && (
                                                <GlassLink variant="glass" href={state.selected.github}
