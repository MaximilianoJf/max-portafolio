...
export const db: Project[] = [
  {
    ...
    technology: ["PHP", "Laravel 10", "SQL", "JavaScript"],
    images: [
        {
          id: 1,
  ...
  },
  {
    ...
    technology: ["C#", "ASP.NET", "MVC", "JavaScript", "SQL Server"],
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    technology: ["React", "UseReducter ", "TypeScript", "JavaScript", "Tailwind"],
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    technology: ["PHP", "Laravel ", "Livewire", "JavaScript", "Tailwind"],
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    technology: ["React", "Zustand ", "TypeScript", "JavaScript", "Tailwind", "OpenRouter", "Zod" ,"Axios"],
    images: [
      {
        id: 1,
  ...
  },
  {
    ...
    technology: ["React", "Zustand ", "TypeScript", "JavaScript", "Tailwind","Zod", "Axios"],
    images: [
      {
        id: 1,
...
/* Commented out - formation data structure doesn't match Category type
    ...
    items: [
      {
        ...
        content: "Migrating critical Excel workflows to normalized MySQL schemas. Developing modular interfaces with React. Optimizing server performance using Laravel Queues and Jobs. Implementing RBAC (Role-Based Access Control) and real-time Laravel Notifications.",
